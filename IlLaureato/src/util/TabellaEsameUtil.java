...
public class TabellaEsameUtil {
   ...
   public static TableColumn<Esame, String> getColonnaRispostaEsatta() {
      ...
      TableColumn<Esame, String> rispostaEsattaEsame = new TableColumn<>(
            "RispostaEsatta");
      rispostaEsattaEsame
            .setCellValueFactory(new PropertyValueFactory<>("rispostaEsatta"));
   ...
   public static TableColumn<Esame, String> getColonnaRispostaSbagliata() {
      ...
      TableColumn<Esame, String> rispostaSbagliataEsame = new TableColumn<>(
            "RispostaSbagliata");
      rispostaSbagliataEsame.setCellValueFactory(
            new PropertyValueFactory<>("rispostaSbagliata"));
