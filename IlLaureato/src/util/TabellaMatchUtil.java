...
public class TabellaMatchUtil {
   ...
   public static ObservableList<MatchTableView> getListaMatch() {
      ...
      ObservableList<MatchTableView> listaMatch = FXCollections
            .observableArrayList();

      for (Match m : tmp) {
         MatchTableView match = new MatchTableView(m.getIdMatch(),
               m.getNumberPlayer(), m.size());
   ...
   public static TableColumn<MatchTableView, Integer> getColonnaIDMatch() {
      ...
      TableColumn<MatchTableView, Integer> idMatch = new TableColumn<>(
            "IDMatch");
   ...
   public static TableColumn<MatchTableView, Integer> getColonnaNumeroGiocatori() {
      ...
      TableColumn<MatchTableView, Integer> numGiocatori = new TableColumn<>(
            "NumeroGiocatori");
      numGiocatori
            .setCellValueFactory(new PropertyValueFactory<>("numeroGiocatori"));
      return numGiocatori;
   ...
   public static TableColumn<MatchTableView, Integer> getColonnaGiocatoriCorrenti() {
      ...
      TableColumn<MatchTableView, Integer> numeroGiocatoriCorrenti = new TableColumn<>(
            "GiocatoriCorrenti");
      numeroGiocatoriCorrenti.setCellValueFactory(
            new PropertyValueFactory<>("giocatoriCorrenti"));
