...
public class EditorDomande {
   ...
   private ImageView editorDomande = new ImageView(
         new Image("file:icone/editorDomande.png"));
   private ImageView nomeEsame = new ImageView(
         new Image("file:icone/nomeEsame.png"));
   private ImageView crediti = new ImageView(
         new Image("file:icone/crediti.png"));
   private ImageView domanda = new ImageView(
         new Image("file:icone/domanda.png"));
   private ImageView rispostaEsatta = new ImageView(
         new Image("file:icone/rispostaEsatta.png"));
   private ImageView rispostaSbagliata = new ImageView(
         new Image("file:icone/rispostaSbagliata.png"));
   ...
   public EditorDomande(Stage stage) {
      ...
      aggiungi.setOnMouseReleased(event -> {
         ...
         Esame esame = new Esame(1, nome, crediti, domanda, rispostaEsatta,
               rispoSbagliata);
