...
public class PaneDomande extends Pane {
   ...
   private ObservableList<String> notifica = FXCollections
         .observableArrayList();
   ...
   public PaneDomande(GameManagerAstratta gm) {
      ...
      this.getStylesheets().add(this.getClass()
            .getResource("/css/domandeCss.css").toExternalForm());
         ...
         public void onChanged(Change<? extends String> c) {
            ...
            if (c.wasAdded()) {
               ...
               if (risposta.equals(risposta1.getText())) {
                  if (azione.controllaEsitoEsame(risposta1.getText(),
                        giocatore)) {
                  ...
                  if (azione.controllaEsitoEsame(risposta2.getText(),
                        giocatore)) {
                     risposta2.setStyle("-fx-background-color: green;");
                     risposta1.setStyle("-fx-background-color: red;");
                     risultato.setText(frase1);
